...
import ua.garmash.internetshop.controllers.ProductRestController;
...
class ProductRestControllerTest {
    ...
    private ProductDto dto = new ProductDto(999L,"V999", "TestProduct","","", 999.99, true, null, null);
    ...
    void getById() throws Exception {
        mockMvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.vendorcode", Matchers.is("V999")))
